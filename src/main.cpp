...
RobotMode currentMode = LINE_MODE;
...
void lineSensor()
{
  ...
  else if (s4 >= blackThreshold && s5 >= blackThreshold)
  {
    analogWrite(MA1, 210);
    analogWrite(MA2, 0);
  ...
  else if (s1 <= blackThreshold && s2 <= blackThreshold && s3 <= blackThreshold && s4 <= blackThreshold && s5 <= blackThreshold && s6 <= blackThreshold && s7 <= blackThreshold && s8 <= blackThreshold)
  {
